<main class="text-black font-serif flex justify-center">
  <div class="w-full max-w-2xl bg-gray-200 text-center border-x border-black p-4">
    ...
    <!-- Garis Pembatas -->
    <div class="my-6 border-t border-black w-full"></div>

    <!-- Teks RSVP -->
    <p class="italic text-sm max-w-xl mx-auto mb-4">
      Please help us prepare by confirming your attendance at our wedding via the form below and sending your congratulations.
    </p>
