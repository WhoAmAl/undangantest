<div class="bg-neutral-950 min-h-screen sm:min-h-[165vh] xl:min-h-screen flex flex-col items-center px-5 sm:px-10 relative" style="background-image: url(/landingopeningretroclassic.png); background-size: cover; background-position: center; background-repeat: no-repeat; font-family: 'Jomolhari', serif;">
    <!-- HEADER -->
    <div class="w-full flex flex-col pt-8 select-none relative">
        <div class="flex flex-col items-start md:gap-3">
            <span class="text-gray-50 text-5xl sm:text-4xl md:text-6xl xl:text-6xl tracking-[0.2em]">SAVE</span>
            <div class="flex-row justify-center items-center flex pl-20 gap-4">
                <span class="text-gray-50 text-xl sm:text-[2rem] xl:text-2xl mt-2 mb-2">THE</span>
                <span class="text-gray-50 text-5xl sm:text-[6rem] md:text-6xl xl:text-6xl tracking-[0.2em] font-serif leading-none">DATE</span>
            </div>
        </div>
    </div>
    <!-- CONTENT BODY -->
    <div class="flex flex-col relative mt-10 w-full text-neutral-50 gap-4">
        <!-- WEDDING CEREMONY -->
