<div class="bg-[#172554] max-w-2xl min-h-screen sm:min-h-[880px] mx-auto flex flex-col relative overflow-hidden">
    ...
    >
        <g filter="url(#filter0_d_266_287)">
            <path
            d="M672 881H0C0 881 165.222 860.815 255.31 823.188C345.398 785.561 383.215 752.286 455.161 690.474C527.108 628.663 569.326 512.311 590.061 451.954C610.796 391.597 672 12 672 12V881Z"
            fill="#FAFAFA"
            />
        </g>
        <defs>
            <filter
            id="filter0_d_266_287"
            x="-12"
            y="0"
            width="696"
            height="893"
            ...
            <feMorphology
                ...
                operator="dilate"
                in="SourceAlpha"
                result="effect1_dropShadow_266_287"
            />
            <feOffset />
            ...
            <feBlend
                mode="normal"
                in="SourceGraphic"
                in2="effect1_dropShadow_266_287"
                result="shape"
            />
            </filter>
        </defs>
